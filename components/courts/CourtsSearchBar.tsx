...
interface CourtsSearchBarProps {
...
export function CourtsSearchBar({
  onFilterChange = () => {},
  ...
  const categoryOptions = ["All Categories", "Tennis", "Basketball", "Football", "Badminton", "Cricket", "Volleyball"]
    ...
    <div className="w-full bg-white rounded-lg shadow-md p-5 mb-6">
      ...
      <div className="flex flex-wrap justify-between items-center mt-4 gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          {["All", "Indoor", "Outdoor", "Premium"].map((tab) => (
            <button
              key={tab}
              onClick={() => handleTabClick(tab)}
              className={`px-4 py-2 rounded-md transition-colors ${
                (tab === "All" && !filterOptions.category) || (tab === filterOptions.category)
        ...
        <div className="flex items-center">
          <span className="text-gray-500 mr-3 hidden sm:inline">View as</span>
