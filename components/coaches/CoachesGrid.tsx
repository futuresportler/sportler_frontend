  ...
  return (
    ...
    >
      ...
      {coaches.map((coach) => (
        <div
          key={coach.id}
          className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-500 flex flex-col h-full relative z-10 transform hover:-translate-y-1 hover:scale-[1.01]"
        >
